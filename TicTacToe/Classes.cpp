...
char* Board::getPositions(void) {//return all the positions on the board
    return positionsSelected;
}


int Board::setPosition(int gridNumber, char user) {//set a given position to x or o
    {
...
char Board::checkRows() {//check the rows for a winner
    int rows = 0;
    int columns = 0;
    int fourInRowX = 0;
    int fourInRowO = 0;
...
char Board::checkColumns() {//check the columns for a winner
    int rows = 0;
    int columns = 0;
    int fourInRowX = 0;
    int fourInRowO = 0;
...
char Board::checkDiagonals() {//check the diagonals for a winner
    char winner = 'z';
    int fourInRowX = 0;
    int fourInRowO = 0;
...
char Board::determineWinner() {//if 4 in a row, then there is a winner
    char winner = 'z';
    winner = checkRows();
    if (winner == 'z')
        winner = checkColumns();
